...
const ServiceCard = ({ title, icon, description }: Props) => {
    return (
        <Tilt className="bg-white dark:bg-gray-800 rounded-lg p-4">
            ...
            <p className="text-center text-sm mt-2 leading-6 text-gray-400 dark:text-gray-300">
                {description}
            </p>

            <div className="text-center mx-auto justify-center flex items-center space-z-1 mb-4 text-gray-800 dark:text-gray-100 mt-4 font-semibold  cursor-pointer hover:text-red-400 transition-all duration-200">
